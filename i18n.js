...
const I18N = {
    es: {
        ...
        'discord.desc': 'Muestra en tu perfil de Discord que estás jugando. Necesitas crear tu propia app gratuita en discord.com/developers/applications y pegar aquí su Client ID.',
        'discord.enable': 'Activar',
        'discord.clientId.placeholder': 'Client ID de tu app de Discord',
        'discord.save': 'Guardar',
        'discord.saved': 'Configuración de Discord guardada.',
        'discord.connectFailed': 'Se guardó, pero no se pudo conectar con Discord (¿lo tienes abierto?).',
    ...
    en: {
        ...
        'discord.desc': 'Shows on your Discord profile that you\'re playing. You need to create your own free app at discord.com/developers/applications and paste its Client ID here.',
        'discord.enable': 'Enable',
        'discord.clientId.placeholder': 'Your Discord app\'s Client ID',
        'discord.save': 'Save',
        'discord.saved': 'Discord settings saved.',
        'discord.connectFailed': 'Saved, but could not connect to Discord (is it running?).',
