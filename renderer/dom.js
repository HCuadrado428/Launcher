...
const openActiveInstanceFolderBtn = document.getElementById('openActiveInstanceFolderBtn');
...
const closeScreenshotsModalBtn = document.getElementById('closeScreenshotsModalBtn');
const screenshotsGrid = document.getElementById('screenshotsGrid');
const favoriteServersList = document.getElementById('favoriteServersList');
const newServerName = document.getElementById('newServerName');
const newServerAddress = document.getElementById('newServerAddress');
const addFavoriteServerBtn = document.getElementById('addFavoriteServerBtn');
...
const openInstanceFolderBtn = document.getElementById('openInstanceFolderBtn');
const shareConfigBtn = document.getElementById('shareConfigBtn');
const configShareStatus = document.getElementById('configShareStatus');
const removeSharedConfigBtn = document.getElementById('removeSharedConfigBtn');
